...
// Pano2VR 6.0.1/17227
// Filename: RoyCustom-B.ggsk
// Generated Tue Aug 3 19:56:45 2021
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._thumbnail_show_button_show.logicBlock_alpha = function() {
			...
			if (me._thumbnail_show_button_show.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._thumbnail_show_button_show.style[domTransition]='opacity 0s, visibility 0s';
		...
		me._thumbnail_hide_button_show.logicBlock_alpha = function() {
			...
			if (me._thumbnail_hide_button_show.ggCurrentLogicStateAlpha != newLogicStateAlpha) {
				...
				me._thumbnail_hide_button_show.style[domTransition]='opacity 0s, visibility 0s';
	...
	function SkinCloner_thumbnail_cloner_Class(nodeId, parentScope,ggParent,parameter) {
		...
		me.__div.setAttribute('style','position: absolute;width: 96px; height: 62px; visibility: inherit; overflow: hidden;');
	...
	player.addListener('changenodeid', function(args) { me._thumbnail_show_button_show.logicBlock_alpha();me._thumbnail_hide_button_show.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha();me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha(); });
	player.addListener('gyrochanged', function(args) { me._gyro_on.logicBlock_alpha();me._gyro_off.logicBlock_alpha(); });
	player.addListener('varchanged_vis_thumbnail_menu', function(args) { me._thumbnail_show_button_show.logicBlock_alpha();me._thumbnail_hide_button_show.logicBlock_alpha();me._thumbnail_menu.logicBlock_alpha(); });
